...
To validate the quality of a \gls{lr}, the most common approach is to compare it with the linear relaxation of the original problem. This relaxation is obtained by flexibilizing the integer variables to real-valued. The linear relaxation is a much easier problem to solve than the original problem, since is a \gls{lp} problem.
